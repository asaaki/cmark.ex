defmodule Cmark do
  ...
  ## Examples
      ...
      iex> callback = fn (result) -> "HTML is #{result}" |> String.trim end
      iex> Cmark.to_html("test", callback)
      "HTML is <p>test</p>"

      iex> callback = fn (results) ->
      iex>   Enum.map(results, &String.trim/1) |> Enum.join("<hr>")
      iex> end
  ...
  ## Examples
      ...
      [
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<!DOCTYPE document SYSTEM \"CommonMark.dtd\">\n<document xmlns=\"http://commonmark.org/xml/1.0\">\n  <paragraph>\n    <text xml:space=\"preserve\">test 1</text>\n  </paragraph>\n</document>\n",
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<!DOCTYPE document SYSTEM \"CommonMark.dtd\">\n<document xmlns=\"http://commonmark.org/xml/1.0\">\n  <paragraph>\n    <text xml:space=\"preserve\">test 2</text>\n  </paragraph>\n</document>\n"
      ]
  ...
  ## Examples
      ...
      "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<!DOCTYPE document SYSTEM \"CommonMark.dtd\">\n<document xmlns=\"http://commonmark.org/xml/1.0\">\n  <paragraph>\n    <text xml:space=\"preserve\">Use option to enable “smart” quotes.</text>\n  </paragraph>\n</document>\n"

      iex> Cmark.to_xml([~s(Something "smart"), ~s(em---dashed)], [:smart])
      [
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<!DOCTYPE document SYSTEM \"CommonMark.dtd\">\n<document xmlns=\"http://commonmark.org/xml/1.0\">\n  <paragraph>\n    <text xml:space=\"preserve\">Something “smart”</text>\n  </paragraph>\n</document>\n",
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<!DOCTYPE document SYSTEM \"CommonMark.dtd\">\n<document xmlns=\"http://commonmark.org/xml/1.0\">\n  <paragraph>\n    <text xml:space=\"preserve\">em—dashed</text>\n  </paragraph>\n</document>\n"
      ]
  ...
  ## Examples
      ...
      iex> callback = fn (result) -> "XML is #{result}" |> String.trim end
      ...
      iex> callback = fn (results) ->
      iex>   Enum.map(results, &String.trim/1) |> Enum.join("<joiner>")
      iex> end
  ...
  ## Examples
      ...
      {
        :ok,
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<!DOCTYPE document SYSTEM \"CommonMark.dtd\">\n<document xmlns=\"http://commonmark.org/xml/1.0\">\n  <paragraph>\n    <text xml:space=\"preserve\">Something “smart” and … —you get it!</text>\n  </paragraph>\n</document>\n"
      }
      ...
      "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<!DOCTYPE document SYSTEM \"CommonMark.dtd\">\n<document xmlns=\"http://commonmark.org/xml/1.0\">\n  <paragraph>\n    <text xml:space=\"preserve\">en-dash –</text>\n  </paragraph>\n</document><joiner><?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<!DOCTYPE document SYSTEM \"CommonMark.dtd\">\n<document xmlns=\"http://commonmark.org/xml/1.0\">\n  <paragraph>\n    <text xml:space=\"preserve\">ellipsis…</text>\n  </paragraph>\n</document>"
  ...
  ## Examples
      ...
      iex> callback = fn (result) -> "Manpage is #{result}" |> String.trim end
  ...
  ## Examples
      ...
      iex> callback = fn (result) -> "CommonMark is #{result}" |> String.trim end
  ...
  ## Examples
      ...
      iex> callback = fn (result) -> "LaTeX is #{result}" |> String.trim end
